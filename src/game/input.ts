...
pointerInputWithPosition([anyInput as Subject<WithPositionInputEvent>, pointer], { events: ["pointerdown", "pointermove", "pointerup"], target: inputArea } as unknown as PointerInputOptions);
...
export const counterInstance = counterMiddleware(durationRepeat, counter) as any;
